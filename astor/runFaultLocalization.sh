...
java  -cp $(cat /tmp/astor-classpath.txt):bin fr.inria.main.evolution.AstorMain \
    ...
    -dependencies /Users/georgecherian/Desktop/TSE/bugs/chart/chart_"$bugID"/lib:/Users/georgecherian/.m2/repository/junit/junit/4.11/junit-4.11.jar:/Users/georgecherian/.m2/repository/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar > "$bugID"_FL_output.txt
